...
//   static const Color yellow = Color(0xffFFF847);
...
//   static const Color blackColor = Color(0xFF17262A);
...
//   static const Color blueMenuColor = Color(0xFF1670BB);
//   static const Color yellowMenuColor = Color(0xFFEB9A3A);
//   static const Color greenMenuColor = Color(0xFF19D542);
//   static const Color pinkMenuColor = Color(0xFFDD2165);
// }

const Color greenColor = Color(0xFF1F9C59);
...
// const Color pinkColor = Color(0xFFF8D2D2);
// const Color softTosca = Color(0xFF71A9A9);
// const Color whiteRed = Color(0xFFF0E9E9);
// const Color pink2Color = Color(0xFFFFE0CE);
